   ...
   for (let key in myObjectsByFirebaseKey) {
     ...
     if (thisObject.type === "image") {
       ...
       if (img) {
         ctx.fillColor = "black";
         ctx.font = "30px Arial";
         ctx.fillText(thisObject.createdByName + ":" + thisObject.prompt, position.x, position.y - 30);
         ctx.drawImage(img, position.x, position.y, 256, 256);
         //  ctx.fillText(thisObject.createdByName, position.x, position.y + 30);
       }
 ...
 function initFirebaseDB() {
   ...
   const firebaseConfig = {
     ...
     //  apiKey: "AIzaSyDHUPV2g1V8qWioRVenIZ8kttqq_Co7kME",
     //  authDomain: "vfvvvf.firebaseapp.com",
     //  databaseURL: "https://vfvvvf-default-rtdb.firebaseio.com",
     //  projectId: "vfvvvf",
     //  storageBucket: "vfvvvf.firebasestorage.app",
     //  messagingSenderId: "631497985056",
     //  appId: "1:631497985056:web:a96f9a618a8cc3a74d0045"
   };
